    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className="text-gray-500">{quote.quote_number} has been marked as sent.</p>
          {quote.client_email && (
            <p className="text-gray-400 text-sm mt-1">Copy would go to {quote.client_email}</p>
          )}
        </div>
      </div>
    );
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="bg-gray-900 text-white p-6 flex justify-between items-start">
            ...
            <div className="text-right">
              <div className="text-xs text-gray-400 mb-1">Quote number</div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <div className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Quote For</div>
                <input
